...
SELECT vendor_id, count(booth_number) AS num_of_rentals
...
SELECT customer_last_name, customer_first_name, SUM(quantity*cost_to_customer_per_qty) as total_spend
